...
function Menu() {
  return (
    <MenuProvider>
      <Container
        asChild
        className="bg-open-menu-container-bg fixed top-0 right-0 z-10 h-[5em] w-fit flex-row-reverse justify-start gap-[0.5em] rounded-bl-[1em] p-[0.6em] text-[max(0.75rem,1.6vmin)] select-text"
      >
        <nav>
          <SettingsButton />
          <InfoButton />
