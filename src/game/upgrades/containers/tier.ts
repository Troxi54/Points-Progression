...
const tierUpgrades = createUpgradeDataContainer({
  ...
  forceShow: ({ player }) => everPerformed(player, "vermyros"),
  upgrades: [
    {
      id: "tier_1",
      description:
        "Prevents Reset upgrades from spending Points and keeps Reset Upgrade 1",
      cost: 1e27
    },
    {
      id: "tier_2",
      description: "Keeps Reset Upgrade 2",
      cost: 1e32
    },
    {
      id: "tier_3",
    ...
    },
    {
      id: "tier_4",
      description:
        "Unlocks Ampliflux, automatically updates Best Points, and removes Auto Reset toggle",
      cost: 1e62
    },
    {
      id: "tier_5",
      description: "Prevents Ampliflux Upgrade from spending Ampliflux",
      cost: 1e74
    },
    {
      id: "tier_6",
      description: "Automates Ampliflux Upgrade",
      cost: 1e82
    }
  ]
});
